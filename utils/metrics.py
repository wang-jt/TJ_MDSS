...
class MovieNetMetric(torchmetrics.Metric):
    def __init__(self):
        ...
        self.vid2idx = json.load(
            ...
            # )
            open('/share2/wangyx/baselines/vss/bassl/bassl/data/movienet/anno/msvd_vid2idx.json', 'r')
        )
        self.idx2vid = {idx: vid for vid, idx in self.vid2idx.items()}
        # self.shot_path = "bassl/data/movienet/scene318/shot_movie318"
        self.shot_path = '/share2/wangyx/baselines/vss/bassl/bassl/data/movienet/scene318/msvd'
